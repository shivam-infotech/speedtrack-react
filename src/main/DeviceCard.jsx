...
import {
  IconButton, Tooltip, ListItemAvatar, useTheme, Typography, Box, Card, CardContent, Menu, MenuItem, Skeleton,
} from '@mui/material';
...
import {
  formatBoolean, formatNumericHours, formatStatus, formatTime, getDeviceStatusColor, getStatusColor,
...
import {
  statusIcon, BatteryLevelIcon, GSMSignalIcon, ACIcon, SatelliteSignalIcon, ChargingIcon, ParkingIcon, FuelIcon, IgnitionIcon,
} from '../common/components/PostionalHelpers';
...
const DeviceCard = ({ data, index, style, onClick }) => {
  ...
  const formattedLastUpdate = () => (position && position?.fixTime ? formatTime(position.fixTime, 'seconds') : '');
